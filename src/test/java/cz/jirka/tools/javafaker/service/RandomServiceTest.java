package cz.jirka.tools.javafaker.service;

import cz.jirka.tools.javafaker.AbstractFakerTest;
...
public class RandomServiceTest extends AbstractFakerTest {
    ...
    @Test
    public void testHex() {
        assertThat(randomService.hex(8), MatchesRegularExpression.matchesRegularExpression("^[0-9A-F]{8}$"));
    }
    @Test
    public void testDefaultHex() {
        assertThat(randomService.hex(), MatchesRegularExpression.matchesRegularExpression("^[0-9A-F]{8}$"));
    }
}
